  ...
  const BlockingError: React.FC = () => {
    switch (blockingError) {
      case ErrorType.CAN_NOT_WITHDRAW_THIS_AMOUNT:
        return (
          <div>
            You can not withdraw this amount because it will cause collateral
            call
          </div>
        );
      case ErrorType.POOL_DOES_NOT_HAVE_ENOUGH_LIQUIDITY:
        return (
          <div>
            These funds have been borrowed and are not available for withdrawal
            at this time.
          </div>
        );
      ...
      <AssetInput
        ...
        balanceText={
          unborrowedLiquidity.lt(underlyingBalance) ? (
            <p className="teaser-voice">Available</p>
          ) : (
            <p className="teaser-voice">Supply balance</p>
          )
        }
      />
        ...
        <>
          ...
          >
            ...
            <Typography variant="description">
              <p>I acknowledge the risks involved.</p>
            </Typography>
          </Box>
        </>
      )}
